 ...
 * 
 * Define todos os tipos de blocos disponíveis com:
...
window.BLOCK_TYPES = [
    ...
    },
    {
        type: 'heading',
        label: 'Título',
        icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5M3.75 17.25h16.5" /></svg>',
        description: 'Adicione um título para separar seções'
    },
    {
        type: 'image',
        label: 'Imagem',
        ...
        description: 'Insira uma imagem ou ícone'
    },
    {
        type: 'video',
        label: 'Vídeo',
        ...
        description: 'Incorpore um vídeo do YouTube ou Vimeo'
    },
    {
        type: 'code',
        label: 'Código',
        ...
        description: 'Exiba código com sintaxe destacada'
    },
    {
        type: 'quote',
        label: 'Citação',
        icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 0 1 .865-.501 48.172 48.172 0 0 0 3.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z" /></svg>',
        description: 'Destaque uma citação importante'
    },
    {
        type: 'alert',
        label: 'Alerta',
        icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" /></svg>',
        description: 'Chame atenção com uma nota importante'
    },
    {
        type: 'list',
        label: 'Lista',
        ...
        description: 'Crie uma lista ordenada ou com marcadores'
    },
    {
        type: 'latex',
        label: 'LaTeX',
        icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0 1 12 16a9.065 9.065 0 0 1-6.23-.693L5 15.3m14.8 0 .7 1.05a1.5 1.5 0 0 1-1.98 2.193l-.88-.44m-4.87 3.396a2.25 2.25 0 0 1-2.625.275l-.882-.441M12 21a2.25 2.25 0 0 1-2.625-.275L8.493 20.28m4.014 1.22v-1m0-4v-1m0-4v-1m0-4v-1" /></svg>',
        description: 'Escreva equações matemáticas com LaTeX'
    },
    {
        type: 'divider',
        label: 'Divisor',
        icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" /></svg>',
        description: 'Separe visualmente seções de conteúdo'
    },
    {
        type: 'table',
        label: 'Tabela',
