    ...
    <div class="block-editor-main" @click.self="deselectBlock()">
        ...
        <aside class="block-editor-sidebar-right" @click="deselectBlock()">
            <div class="sidebar-section">
                <div class="sidebar-section-title">Status da Lição</div>
                <div class="sidebar-info-item">
                    <span x-text="lesson?.is_active ? 'Ativa' : 'Inativa'" 
                          :class="lesson?.is_active ? 'text-green-600' : 'text-gray-500'"
            ...
            <div class="sidebar-section">
                ...
                <div class="sidebar-info-item" x-text="lastSavedAt || '--'"></div>
            </div>
        </aside>
    </div>
