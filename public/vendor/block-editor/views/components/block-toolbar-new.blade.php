...
>
    ...
    @include('block-editor-ymnk::components.toolbar.block-controls')
    ...
    <template x-if="block.type === 'paragraph'">
        <div class="block-toolbar-section">
            @include('block-editor-ymnk::components.toolbar.alignment-dropdown')
            <div class="block-toolbar-divider"></div>
            @include('block-editor-ymnk::components.toolbar.text-formatting')
        </div>
    </template>
    ...
    <template x-if="block.type === 'heading'">
        <div class="block-toolbar-section">
            @include('block-editor-ymnk::components.toolbar.heading-level')
            <div class="block-toolbar-divider"></div>
            @include('block-editor-ymnk::components.toolbar.alignment-dropdown')
            <div class="block-toolbar-divider"></div>
            @include('block-editor-ymnk::components.toolbar.text-formatting')
    ...
    <template x-if="block.type === 'paragraph' || block.type === 'heading'">
        @include('block-editor-ymnk::components.toolbar.color-picker-full')
    </template>
    ...
    <div class="block-toolbar-section">
        @include('block-editor-ymnk::components.toolbar.more-options')
    </div>
</div>
