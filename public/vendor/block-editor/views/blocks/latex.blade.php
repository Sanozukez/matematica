...
>
        ...
        <div class="block-latex">
            <div class="block-latex-editor">
                <div class="block-latex-label">
                    ...
                    <span>LaTeX</span>
                    <button 
                        class="block-latex-help-btn"
                        @click.prevent="window.open('/latex-guide', 'latex_guide', 'width=1200,height=800')"
                        title="Abrir guia de LaTeX"
                    >
    ...
    <style>
        ...
        .block-latex-help-btn:hover {
            background: rgba(0, 124, 186, 0.1);
            color: #005A87;
        }
        
        .block-latex-help-btn .material-icons {
            font-size: 18px;
        }
