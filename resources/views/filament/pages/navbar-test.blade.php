{{-- Navbar Test Page (dentro do Filament Admin) --}}
<x-filament-panels::page>
    <div class="space-y-6">
        {{-- Test Navbar Above Content --}}
        <div class="mb-6">
            <h2 class="mb-4 text-xl font-bold">Navbar Isolada (Test)</h2>
                ...
                <nav class="platform-navbar flex h-16 items-center gap-x-4 bg-white px-4 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 md:px-6 lg:px-8">
                    ...
                    <div class="flex items-center gap-x-2">
                        <a href="{{ route('filament.admin.pages.dashboard') }}" class="flex items-center gap-x-2 font-semibold text-gray-950 dark:text-white hover:opacity-75 transition-opacity">
                            ...
                            {{-- Brand text (can be made dynamic) --}}
                        ...
                        @auth
                            <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                                ...
                                >
                                    ...
                                    {{-- Theme Switcher --}}
                                    <div class="border-b border-gray-100 px-4 py-3 dark:border-gray-800">
                                        <div x-data="{ theme: localStorage.getItem('theme') || 'system' }" class="flex items-center justify-center gap-1">
                                            {{-- Light Theme Button --}}
                                            <button
                                                type="button"
        ...
        <div class="grid gap-6 md:grid-cols-2">
            <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
                <h3 class="mb-4 font-semibold">Checklist da Navbar</h3>
                <ul class="space-y-2 text-sm">
                    <li class="flex items-center gap-2">
                        <svg class="h-4 w-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                        </svg>
                        <span>Ícone book-open (Heroicons)</span>
                    </li>
                    <li class="flex items-center gap-2">
                        <svg class="h-4 w-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                        </svg>
                        <span>Texto "Matemática" (hidden em mobile)</span>
                    </li>
                    <li class="flex items-center gap-2">
                        <svg class="h-4 w-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                        </svg>
                        <span>Avatar à direita com dropdown</span>
                    </li>
                    <li class="flex items-center gap-2">
                        <svg class="h-4 w-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                        </svg>
                        <span>3 ícones de tema (light/dark/system)</span>
                    </li>
                    <li class="flex items-center gap-2">
                        <svg class="h-4 w-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                        </svg>
                        <span>Tema aplicado com classe .dark</span>
                    </li>
                    <li class="flex items-center gap-2">
                        <svg class="h-4 w-4 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                        </svg>
                        <span>Dropdown funciona corretamente</span>
                    </li>
                </ul>
            </div>

            <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
                <h3 class="mb-4 font-semibold">Próximos Passos</h3>
                <ul class="space-y-2 text-sm">
                    <li>1. Testar dropdown (clique no avatar)</li>
                    <li>2. Testar temas (light/dark/system)</li>
                    <li>3. Verificar classe .dark no &lt;html&gt;</li>
                    <li>4. Copiar HTML para o editor</li>
                    <li>5. Integrar na página editor</li>
                </ul>
            </div>
        </div>
    </div>
